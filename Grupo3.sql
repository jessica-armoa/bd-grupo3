...
if exists (select 1
   from sys.sysreferences r join sys.sysobjects o on (o.id = r.constid and o.type = 'F')
   where r.fkeyid = object_id('DETALLES_FACTURAS') and o.name = 'FK_DETALLES_RELATIONS_PRODUCT')
alter table DETALLES_FACTURAS
   drop constraint FK_DETALLES_RELATIONS_PRODUCT
go
...
if exists (select 1
   from sys.sysreferences r join sys.sysobjects o on (o.id = r.constid and o.type = 'F')
   where r.fkeyid = object_id('DETALLES_PRODUCTOS_UTILIZADOS') and o.name = 'FK_DETALLES_RELAT_PROD')
alter table DETALLES_PRODUCTOS_UTILIZADOS
   drop constraint FK_DETALLES_RELAT_PROD
go

if exists (select 1
   from sys.sysreferences r join sys.sysobjects o on (o.id = r.constid and o.type = 'F')
   where r.fkeyid = object_id('DETALLES_TRANSFERENCIAS') and o.name = 'FK_DETALLES_RELAT_PRODUCTO')
alter table DETALLES_TRANSFERENCIAS
   drop constraint FK_DETALLES_RELAT_PRODUCTO
go
...
if exists (select 1
   from sys.sysreferences r join sys.sysobjects o on (o.id = r.constid and o.type = 'F')
   where r.fkeyid = object_id('TRANSFERENCIAS') and o.name = 'FK_TRANSFER_RELATIONS_DEPOSI')
alter table TRANSFERENCIAS
   drop constraint FK_TRANSFER_RELATIONS_DEPOSI
go

if exists (select 1
   from sys.sysreferences r join sys.sysobjects o on (o.id = r.constid and o.type = 'F')
   where r.fkeyid = object_id('TRANSFERENCIAS') and o.name = 'FK_TRANSFER_RELATIONS_EMP')
alter table TRANSFERENCIAS
   drop constraint FK_TRANSFER_RELATIONS_EMP
go

if exists (select 1
   from sys.sysreferences r join sys.sysobjects o on (o.id = r.constid and o.type = 'F')
   where r.fkeyid = object_id('TRANSFERENCIAS') and o.name = 'FK_TRANSFER_RELATIONS_EMPLEA')
alter table TRANSFERENCIAS
   drop constraint FK_TRANSFER_RELATIONS_EMPLEA
go

if exists (select 1
   from sys.sysreferences r join sys.sysobjects o on (o.id = r.constid and o.type = 'F')
   where r.fkeyid = object_id('TRANSFERENCIAS') and o.name = 'FK_TRANSFER_RELAT_DEPO')
alter table TRANSFERENCIAS
   drop constraint FK_TRANSFER_RELAT_DEPO
go
...
alter table DETALLES_FACTURAS
   add constraint FK_DETALLES_RELATIONS_PRODUCT foreign key (PRODUCTO_ID)
...
alter table DETALLES_PRODUCTOS_UTILIZADOS
   add constraint FK_DETALLES_RELAT_PROD foreign key (PRODUCTO_ID)
      references PRODUCTOS (PRODUCTO_ID)
go

alter table DETALLES_TRANSFERENCIAS
   add constraint FK_DETALLES_RELAT_PRODUCTO foreign key (PRODUCTO_ID)
      references PRODUCTOS (PRODUCTO_ID)
go

alter table DETALLES_TRANSFERENCIAS
   add constraint FK_DETALLES_RELATIONS_TRANSFER foreign key (TRANFERENCIA_ID)
...
alter table TRANSFERENCIAS
   add constraint FK_TRANSFER_RELATIONS_DEPOSI foreign key (DEPOSITO_DESTINO_ID)
      references DEPOSITOS (DEPOSITO_ID)
go
...
alter table TRANSFERENCIAS
   add constraint FK_TRANSFER_RELAT_DEPO foreign key (DEPOSITO_ORIGEN_ID)
      references DEPOSITOS (DEPOSITO_ID)
go
